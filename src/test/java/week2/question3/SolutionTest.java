...
class SolutionTest {
    ...
    void solution() {
        ...
        assertEquals("(None)", new Solution().solution("ABC", new String[] {"00:00,00:05,HI,ABC#ABC"}));
        assertEquals("HI", new Solution().solution("ABC", new String[] {"00:00,00:06,HI,ABC#ABC"}));
    }
}